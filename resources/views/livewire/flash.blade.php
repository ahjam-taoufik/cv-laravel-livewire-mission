<div>
    <div x-data="{ open: false }" @flash-message.window="open = true; window.scrollTo(0, 0); setTimeout(() => open = false, 2000);" x-cloak>
      <div x-show.transition.opacity="open" class="{{ $type ? $styleByType[$type]: '' }}  rounded mb-3" role="alert">
        <div class="flex p-5">
